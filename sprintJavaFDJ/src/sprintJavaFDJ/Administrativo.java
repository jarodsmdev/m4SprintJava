...
//	- Experiencia previa: máximo 100 caracteres
	...
	// el bob con usuario
	public Administrativo(String nombreUsuario, String area, String expPrevia, String nombreuser, String fechaN,
			int run) {
	...
	@Override
			public void analizarUsuario() {
				Utilidades.escribir("Administrativo" + super.toString()+ "area " +area + ", expPrevia=" + expPrevia) ;
